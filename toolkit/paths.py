...
def split_extension(name):
    """Split a path into stem and last extension, posix-style."""
...
def common_prefix(paths):
    ...
    An empty sequence yields the empty string. Comparison is after
    slash normalisation, component by component.
    """
    if not paths:
        return ""
